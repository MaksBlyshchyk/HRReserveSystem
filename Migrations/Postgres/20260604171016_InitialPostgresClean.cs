        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SoftSkillAssessments_Communication", "\"Communication\" BETWEEN 1 AND 10");
                    table.CheckConstraint("CK_SoftSkillAssessments_Leadership", "\"Leadership\" BETWEEN 1 AND 10");
                    table.CheckConstraint("CK_SoftSkillAssessments_Responsibility", "\"Responsibility\" BETWEEN 1 AND 10");
                    table.CheckConstraint("CK_SoftSkillAssessments_StressResistance", "\"StressResistance\" BETWEEN 1 AND 10");
                    table.CheckConstraint("CK_SoftSkillAssessments_Teamwork", "\"Teamwork\" BETWEEN 1 AND 10");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Applications_Status", "\"Status\" IN ('New','Screening','Interview','TestTask','Offer','Hired','Rejected')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_InterviewFeedbacks_Score", "\"Score\" BETWEEN 1 AND 10");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InterviewFeedbacks_Recruiters_RecruiterId",
                        column: x => x.RecruiterId,
                        principalTable: "Recruiters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
