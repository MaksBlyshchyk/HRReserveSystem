...
Інтеграційні тести xUnit перевіряють login, ролі, обмеження БД, resume upload, API-відповіді, базові CRUD-сценарії та створення `EmailOutbox`-повідомлень після створення/редагування співбесіди. GitHub Actions workflow `.github/workflows/ci.yml` виконує:
...
12. Створити або відредагувати співбесіду і перевірити, що в папці `EmailOutbox` з'явився `.txt` файл із кандидатом, вакансією, датою, типом співбесіди і відповідальним.
13. Створити feedback і soft skills; оцінки поза діапазоном 1-10 мають блокуватися.
